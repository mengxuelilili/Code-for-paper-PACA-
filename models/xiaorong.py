# 一身大修训练用了这个（大修修订版：每个数据集独立 6:2:2 训练+测试）重要！！！
# import torch
...
#     # ========================
#     # STEP 1: Collect samples WITH dataset label
#     # ========================
#     all_train_samples = []
#     sample_weights = []
#     dataset_weights = {
...
#     # Validation: keep original distribution (no weighting)
#     val_samples = []
...
#     save_path = "/tmp/AbAgCDR/model/best_model.pth"  # 定义保存路径
...
#                 'params': best_params,
#                 'label_scaler': label_scaler  # 👈 关键！
#             }, save_path)
#             print(f"🎉 Best model saved at {save_path}")

#     # ========================
#     # STEP 3: Final evaluation with best model
#     # ========================
...
#     print("\n" + "="*60)
#     print("🧪 FINAL TEST RESULTS (with best model)")
#     print("="*60)
...
# # 这个是最新去掉独立测试集benchmark数据后的测试集，清洗数据集了，并保存最佳模型/tmp/AbAgCDR/model/best_modelxin.pth
# import torch
# import torch.nn as nn
# import numpy as np
# import random
...
#     save_path = "/tmp/AbAgCDR/model/best_modelxin.pth"    # best_modelxin2
